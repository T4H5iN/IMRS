...
<h1 align="left" style="margin-top: 20px; margin-left: 50px; margin-bottom: 0">WatchList</h1>
...
<?php
    ...
    $sql = "SELECT titleID FROM List WHERE username = :username AND listName = 'Watchlist'";
    ...
    foreach ($listedTitles as $movie) {
        ...
        echo "<a href='Delete_from_List.php?id=$imdbId&list=Watchlist'><button style='width: 220px; background-color: #172c44'>Delete</button></a></div>";
